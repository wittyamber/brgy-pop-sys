...
<body>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <button class="btn btn-sm btn-info" data-bs-toggle="modal" data-bs-target="#viewModal"
                                    ...
                                    data-household="<?= $member['household_number']; ?>"
                                    data-purok="<?= $member['purok_name']; ?>"
                                    data-age="<?= $member['age']; ?>"
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <p><strong>Household Head:</strong> <span id="viewHouseholdHead"></span></p> 
                        <p><strong>Household Number:</strong> <span id="viewHousehold"></span></p>
                        <p><strong>Purok:</strong> <span id="viewPurok"></span></p>
                        <p><strong>Age:</strong> <span id="viewAge"></span></p>
                        <p><strong>Gender:</strong> <span id="viewGender"></span></p>
                        <p><strong>Tribe:</strong> <span id="viewTribe"></span></p>
                        <p><strong>Occupation:</strong> <span id="viewOccupation"></span></p>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                    </div>
    ...
    <script>
        ...
        // View Modal
        function viewHouseholdMemberDetails(memberId) {
            console.log("Member ID: ", memberId); 
            $.ajax({
            url: 'fetch_household_members_details.php',
            type: 'GET',
            data: { id: memberId },
            beforeSend: function() {
                $('#viewModal .modal-body').html('<div class="spinner-border text-primary"></div>');
            },
            success: function(response) {
                ...
                var data = JSON.parse(response);
                    ...
                    $('#viewHouseholdHead').text(data.household_head_name);
                    $('#viewHousehold').text(data.household_number);
                    $('#viewPurok').text(data.purok_name);
                    $('#viewAge').text(data.age);
                    $('#viewGender').text(data.gender);
                    $('#viewTribe').text(data.tribe);
